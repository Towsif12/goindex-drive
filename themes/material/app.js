...
document.write("<style> * { font-size: 100%; font-family: 'Yusei Magic'; } .mdui-progress-indeterminate:before { position: absolute; top: 0; bottom: 0; left: 0; content: ' '; background-color: grey; -webkit-animation: mdui-progress-indeterminate 2s linear infinite; animation: mdui-progress-indeterminate 2s linear infinite; will-change: left, width } .mdui-progress-indeterminate:after { position: absolute; top: 0; bottom: 0; left: 0; content: ' '; background-color: grey; -webkit-animation: mdui-progress-indeterminate-short 2s linear infinite; animation: mdui-progress-indeterminate-short 2s linear infinite; will-change: left, width } </style>")
...
function nav(path) {
    ...
    <a href="https://github.com/Towsif12" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Visit TowsifKafi on Github'}">
